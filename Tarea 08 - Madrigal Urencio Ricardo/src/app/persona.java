...
public class persona extends javax.swing.JFrame {
    ...
    public static final String URL = "jdbc:mysql://localhost:3306/fes_aragon"; //Direccion, puerto y nombre de la Base de Datos
    ...
    public static final String PASSWORD = "maranes"; //Password del usuario, para la configuracion por defecto se mantienen en blanco
